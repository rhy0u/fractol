...
/*   Updated: 2017/03/03 10:14:24 by jcentaur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	iter(t_cd z, t_cd c, int iter)
{
	...
	{
		tmp = z.x * z.x * z.x * z.x * z.x * z.x + 15 * z.x * z.x * z.y * z.y
			* z.y * z.y - 15 * z.x * z.x * z.x * z.x * z.y * z.y - z.y
			* z.y * z.y * z.y * z.y * z.y + c.x;
		z.y = 6 * z.x * z.x * z.x * z.x * z.x * z.y - 20 * z.x * z.x * z.x
			* z.y * z.y * z.y + 6 * z.x * z.y * z.y * z.y * z.y * z.y + c.y;
		z.x = tmp;
		inc++;
	}
	return (inc);
